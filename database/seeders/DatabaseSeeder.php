    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            [
                ...
                'nik' => 11111,
                'nama' => 'ibnu',
                'email' => 'support1@simdabesmiwa.id',
                'jenis_kelamin' => 'laki laki',
                'kota_kelahiran' => 'Jakarta',
                'tanggal_lahir' => '1990-01-01',
                'pekerjaan' => 'Engineer',
        ...
        DB::table('users')->insert([
            [
                ...
                'nik' => 33333333,
                'nama' => 'jamil',
                'email' => 'support2@simdabesmiwa.id',
                'jenis_kelamin' => 'laki laki',
                'kota_kelahiran' => 'Jakarta',
                'tanggal_lahir' => '1990-01-01',
                'pekerjaan' => 'Engineer',
        ...
        DB::table('users')->insert([
            [
                ...
                'nik' => 54321,
                'nama' => 'admin2',
                'email' => 'support5@simdabesmiwa.id',
                'jenis_kelamin' => 'perempuan',
                'kota_kelahiran' => 'Jakarta',
                'tanggal_lahir' => '1990-01-01',
                'pekerjaan' => 'Engineer',
        ...
        DB::table('users')->insert([
            [
                ...
                'nik' => 44444,
                'nama' => 'siniar',
                'email' => 'support7@simdabesmiwa.id',
                'jenis_kelamin' => 'perempuan',
                'kota_kelahiran' => 'Jakarta',
                'tanggal_lahir' => '1990-01-01',
                'pekerjaan' => 'Engineer',
